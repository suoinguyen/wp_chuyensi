...
?>
    <style>
        ...
        .contact-page-container h1:after {
            font-size:25px;
            color:#D6CFCB;
            content:'&';
            text-align:center;
        ...
        .contact-page-container #content:after {
            background:#F9F9F9;
            margin:10px;
            position: absolute;
            content :" ";
        ...
        .contact-page-container input:required, textarea:required {
            -moz-box-shadow:none;
        ...
        /** inputs and textarea**/
        .contact-page-container input:not([type="submit"]), textarea {
            outline:none;
            display:block;
            width: 100%;
            padding:4px 8px;
        ...
        .contact-page-container input:not([type="submit"]):active, textarea:active, input:not([type="submit"]):focus, textarea:focus {
            background:#F7F7F7;
        ...
        .contact-page-container input:not([type="submit"]){
            height: 40px;
            margin-top: 10px;
        }
        ...
        .contact-page-container input:-moz-placeholder, textarea:-moz-placeholder {
            color:#BABABA;
            font-style:italic;
        }
        .contact-page-container textarea {
        ...
        .contact-page-container label:hover {
            color:#191919;
        }
        .contact-page-container label:before {
            color:#C1BFBD;
            -webkit-transition: color 1s ease;
            -moz-transition: color 1s ease;
            transition: color 1s ease;
        }
        .contact-page-container label:hover:before {
            color:#969696;
            -webkit-transition: color 1s ease;
            -moz-transition: color 1s ease;
            transition: color 1s ease;
        }
        .contact-page-container .form-element {
            margin-bottom:20px;
        }
        .contact-page-container .indication {
            color:#878787;
            font-size:12px;
            font-style:italic;
            text-align:right;
        ...
        .contact-page-container input[type=submit]:active, input[type=submit]:focus {
            position:relative;
            top:1px;
            color:#515151;
