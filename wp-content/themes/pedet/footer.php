                    ...
                    <div class="service-wapper">
                        <div class="row">
                            <div class="col-sm-6 image">
                                <div class="icon">
                                    <img src="<?php echo _SU_THEME_HOST_PATCH?>/assets/data/icon-s1.png" alt="service">
                                </div>
                ...
                <li class="col-xs-12 col-sm-6 col-md-4 services2-item">
                    <div class="service-wapper">
                        <div class="row">
                            <div class="col-sm-6 image">
                                <div class="icon">
                                    <img src="<?php echo _SU_THEME_HOST_PATCH?>/assets/data/icon-s2.png" alt="service">
                                </div>
                ...
                <li class="col-xs-12 col-sm-6 col-md-4 services2-item">
                    <div class="service-wapper">
                        <div class="row">
                            <div class="col-sm-6 image">
                                <div class="icon">
                                    <img src="<?php echo _SU_THEME_HOST_PATCH?>/assets/data/icon-s3.png" alt="service">
                                </div>
                ...
                <li class="col-xs-12 col-sm-6 col-md-4 services2-item">
                    <div class="service-wapper">
                        <div class="row">
                            <div class="col-sm-6 image">
                                <div class="icon">
                                    <img src="<?php echo _SU_THEME_HOST_PATCH?>/assets/data/icon-s4.png" alt="service">
                                </div>
                ...
                <li class="col-xs-12 col-sm-6 col-md-4 services2-item">
                    <div class="service-wapper">
                        <div class="row">
                            <div class="col-sm-6 image">
                                <div class="icon">
                                    <img src="<?php echo _SU_THEME_HOST_PATCH?>/assets/data/icon-s5.png" alt="service">
                                </div>
                ...
                <li class="col-xs-12 col-sm-6 col-md-4 services2-item">
                    <div class="service-wapper">
                        <div class="row">
                            <div class="col-sm-6 image">
                                <div class="icon">
                                    <img src="<?php echo _SU_THEME_HOST_PATCH?>/assets/data/icon-s6.png" alt="service">
                                </div>
        ...
        <div id="trademark-box" class="row">
            <div class="col-sm-12">
                <ul id="trademark-list">
                    ...
                    <li>
                        <a href="#"><img src="<?php echo _SU_THEME_HOST_PATCH?>/assets/data/trademark-ups.jpg"  alt="ups"/></a>
                    </li>
                    <li>
                        <a href="#"><img src="<?php echo _SU_THEME_HOST_PATCH?>/assets/data/trademark-qiwi.jpg"  alt="ups"/></a>
                    </li>
                    <li>
                        <a href="#"><img src="<?php echo _SU_THEME_HOST_PATCH?>/assets/data/trademark-wu.jpg"  alt="ups"/></a>
                    </li>
                    <li>
                        <a href="#"><img src="<?php echo _SU_THEME_HOST_PATCH?>/assets/data/trademark-cn.jpg"  alt="ups"/></a>
                    </li>
                    <li>
                        <a href="#"><img src="<?php echo _SU_THEME_HOST_PATCH?>/assets/data/trademark-visa.jpg"  alt="ups"/></a>
                    </li>
                    <li>
                        <a href="#"><img src="<?php echo _SU_THEME_HOST_PATCH?>/assets/data/trademark-mc.jpg"  alt="ups"/></a>
                    </li>
                    <li>
                        <a href="#"><img src="<?php echo _SU_THEME_HOST_PATCH?>/assets/data/trademark-ems.jpg"  alt="ups"/></a>
                    </li>
                    <li>
                        <a href="#"><img src="<?php echo _SU_THEME_HOST_PATCH?>/assets/data/trademark-dhl.jpg"  alt="ups"/></a>
                    </li>
                    <li>
                        <a href="#"><img src="<?php echo _SU_THEME_HOST_PATCH?>/assets/data/trademark-fe.jpg"  alt="ups"/></a>
                    </li>
                    <li>
                        <a href="#"><img src="<?php echo _SU_THEME_HOST_PATCH?>/assets/data/trademark-wm.jpg"  alt="ups"/></a>
                    </li>
                </ul>
            </div>
        </div> <!-- /#trademark-box -->
