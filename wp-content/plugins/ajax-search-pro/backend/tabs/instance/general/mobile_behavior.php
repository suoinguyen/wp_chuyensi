<div class="item">
    <?php
    $o = new wpdreamsYesNo("mob_display_search", "Display the search bar on mobile devices?",
        $sd['mob_display_search']);
    $params[$o->getName()] = $o->getData();
    ?>
    <p class="descMsg">If you want to hide this search bar on mobile devices then turn OFF this option.</p>
</div>
<div class="item">
    <?php
