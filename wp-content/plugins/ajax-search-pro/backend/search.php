...
<div id="wpd_shortcode_modal" sid="<?php echo $search['id']; ?>" class="wpd-modal hiddend">
    ...
    <div class="sortablecontainer wpd_md_col">
        <p class="descMsg">This tool is to help you generate a Column/Row based layout for the plugin. For more info on shortcodes, <a href="wp-dreams.com/go/?to=yt-shortcodes" target="_blank">check this video</a> tutorial.</p>
...
<div id="wpdreams" class='wpdreams wrap' data-searchid="<?php echo $_GET['asp_sid']; ?>">
