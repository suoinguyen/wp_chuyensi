    ...
    private function init() {
        ...
        foreach ($instances as $k => $instance) {
            ...
            $this->instances[$instance['id']]['data'] = array_merge(
                 ...
                 *  2. wd_decode_params(..) -> decodes params that are stored in base64 and prefixed to be decoded
                 *
                 * This is not equivalent with wd_parse_params(..) as that runs before inserting to the DB as well,
                 * and wd_decode_params(..) runs after getting the data from the database, so it stays redundant.
                 */
